  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white" style={{ fontFamily: "'Outfit', sans-serif" }}>
      <style jsx global>{`
        ...
        .gold-border { border-color: rgba(224,205,87,0.3); }
        .gold-border-hover:hover { border-color: rgba(224,205,87,0.6); }
      ...
      <header className="fixed top-0 w-full z-50" style={{ background: 'rgba(10,10,10,0.85)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(224,205,87,0.08)' }}>
        <div className="max-w-6xl mx-auto px-5 py-3 flex items-center justify-between">
          <Link href="/"><img src="/icon.png" alt="Outam" className="h-10 w-auto" /></Link>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className={`flex flex-col sm:flex-row gap-3 justify-center md:justify-start ${visible ? 'fade-up fade-up-d4' : 'opacity-0'}`}>
                ...
                <Link href="/menu/demo" className="btn-outline rounded-full px-6 py-4 text-sm text-center flex items-center justify-center gap-2">
                ...
                <div className="phone-screen">
                  ...
                  <div className="bg-[#0F0F0F] p-3 space-y-2">
                    ...
                    <div className="text-center pt-2">
                      <p className="text-[8px] text-white/20">Menu cree avec Outam</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-5xl mx-auto px-5">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold" style={{ fontFamily: "'Playfair Display', serif" }}>
              Comment ca <span className="gold-gradient">marche</span> ?
            </h2>
          </div>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-5">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold" style={{ fontFamily: "'Playfair Display', serif" }}>
              Tout ce qu il <span className="gold-gradient">vous faut</span>
            </h2>
          </div>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-12" style={{ fontFamily: "'Playfair Display', serif" }}>
            Les restaurants <span className="gold-gradient">senegalais</span> adoptent Outam
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="card-glass rounded-2xl p-6 text-left transition-all duration-300">
                <div className="flex items-center gap-1 mb-4">
                  {[1,2,3,4,5].map(s => <span key={s} className="gold-text text-sm">★</span>)}
                </div>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full" style={{ background: 'radial-gradient(circle, rgba(224,205,87,0.06) 0%, transparent 70%)' }} />
        </div>
        <div className="relative max-w-3xl mx-auto px-5 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
            Pret a <span className="gold-gradient">digitaliser</span><br />votre menu ?
          </h2>
          ...
          <Link href="/auth/signup" className="btn-gold rounded-full px-10 py-4 text-base inline-block">
      ...
      <footer style={{ borderTop: '1px solid rgba(224,205,87,0.08)' }}>
        <div className="max-w-6xl mx-auto px-5 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-500 text-sm">Menus digitaux pour restaurants au Senegal</span>
          </div>
