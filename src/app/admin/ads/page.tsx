        ...
        {showForm && (
          <div className="bg-white rounded-2xl p-6 border border-brand-200 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-3">
              ...
              <div><label className="text-xs font-semibold uppercase tracking-wider text-gray-400 block mb-1">Images</label><input type="file" accept="image/*" multiple onChange={e => setImageFiles(Array.from(e.target.files || []))} className="input-field text-sm" /></div>
            </div>
            {/* Existing images */}
