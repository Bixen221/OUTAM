    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="font-display text-xl font-bold"><img src="/icon.png" alt="Outam" className="h-10 w-auto" /></span>
        </div>
      </header>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 space-y-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(8, 1fr)', gap: 8, maxWidth: 320 }}>{['#DC2626','#E11D48','#EA580C','#D97706','#CA8A04','#E0CD57','#65A30D','#16A34A','#15803D','#0F766E','#0D9488','#0891B2','#0284C7','#1D4ED8','#1E40AF','#3300FF','#4F46E5','#6D28D9','#7C3AED','#C026D3','#BE185D','#B45309','#78716C','#1A1917'].map((c) => <button key={c} onClick={() => setForm({...form, theme_color: c})} style={{ width: 32, height: 32, borderRadius: '50%', border: form.theme_color === c ? '3px solid #1A1917' : '2px solid transparent', background: c, cursor: 'pointer', transition: 'all 0.2s', transform: form.theme_color === c ? 'scale(1.15)' : 'scale(1)', boxShadow: form.theme_color === c ? '0 2px 8px rgba(0,0,0,0.2)' : 'none' }} />)}</div>
            </div>
          </div>
